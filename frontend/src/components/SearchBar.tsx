      ...
      <form onSubmit={handleSearch} className="w-full">
        <div className="relative">
          <input
            ...
            className="w-full px-6 py-4 text-lg bg-white/10 backdrop-blur-sm border border-purple-500/30 rounded-full focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20 text-white placeholder-gray-300 transition-all duration-300"
          />
          <button
            type="submit"
